module Contexts
  module InstructorContexts
    def create_instructors
      @mark   = FactoryBot.create(:instructor ,first_name: "Mark", last_name: "Heimann", bio:"A stupendous chess player as you have ever seen.", user: @mark_user, active: true)
      @alex   = FactoryBot.create(:instructor ,first_name: "Alex", last_name: "Heimann", bio: nil, user: @alex_user, active: true)
      @rachel = FactoryBot.create(:instructor, first_name: "Rachel", last_name: "Heimann", bio: nil, user: @rachel_user, active: false)
    end
