...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { active: @family.active, family_name: @family.family_name, parent_first_name: @family.parent_first_name } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { active: @family.active, family_name: @family.family_name, parent_first_name: @family.parent_first_name } }
